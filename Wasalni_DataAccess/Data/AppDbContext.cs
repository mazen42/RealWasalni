...
namespace Wasalni_DataAccess.Data
{
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<DriverProfile>().HasMany(x => x.busTrips).WithOne(x => x.DriverProfile).HasForeignKey(x => x.DriverProfileId).OnDelete(DeleteBehavior.NoAction).IsRequired(false);
